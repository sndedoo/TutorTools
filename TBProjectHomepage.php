            ...
            <nav class="navBar" id="navStudent">
                <ul class="nav nav-pills">
                    ...
                    <li  role="presentation" class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="/Thomas-Student-Service-Request.html" role="button" aria-haspopup="true" aria-expanded="false">Meetings<span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a href="/Thomas-Student-Service-Request.html">Schedule Meeting</a></li>
                            <li><a href="/Thomas-ViewStudentSchedule.html">View Student Schedule</a></li>
                            <li><a href="/Senya - profileSearch.html">Search By Major</a></li>
                        </ul>
                    </li>
                    <li role="presentation" class="dropdown">
                    ...
                    <li class="pillItem"><a href="SD_editProfile.php"> Profile</a></li>
