                ...
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                            aria-expanded="false">Review<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="pillItem"><a href="TBViewStudentSchedule.html">View My Schedule</a></li>
                    <li role="presentation" class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                    ...
                    <li role="presentation" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="pillItem"><a href="SD_logIn.php">Log In</a></li>
                            <li class="pillItem"><a href="SD_createProfile.php">Create Profile</a></li>
